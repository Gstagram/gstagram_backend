...
public class QScrap extends EntityPathBase<Scrap> {
    ...
    private static final long serialVersionUID = -600076527L;
    ...
    public final DateTimePath<java.time.LocalDateTime> scrapDate = createDateTime("scrapDate", java.time.LocalDateTime.class);
